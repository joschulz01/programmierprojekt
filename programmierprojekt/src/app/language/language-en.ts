export const EN_TRANSLATIONS: Record<string, string> = {
  ...
  parameterButton: "Input with Parameters",
  highsSolverButton: "Input with Textarea (HiGHS)",
  ...
  featureDownloadOptions: "Download Options: Results can be downloaded in LP format to allow seamless integration into existing workflows.",
